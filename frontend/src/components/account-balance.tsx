...
import { ALICE, FAUCET_URLS } from "../lib/constants"
...
export function AccountBalance() {
    ...
    return (
        <div className="flex h-11 w-fit items-center gap-2.5 rounded-xl border border-input px-6 font-mono text-sm ring-1 ring-foreground/10 ring-offset-2 ring-offset-background transition-all w-full">
